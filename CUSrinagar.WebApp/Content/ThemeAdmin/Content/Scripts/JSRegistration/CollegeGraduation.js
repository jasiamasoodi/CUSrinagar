...
$(document).ready(function ($) {
    ...
    $("#jspreview").focus(function () {
        $("#StdRegistration").attr("action", "/CUCollegeAdminPanel/CollegeRegistration/GraduationPreview");
    ...
    $("#jsfinalSubmit").focus(function () {
        $("#StdRegistration").attr("action", "/CUCollegeAdminPanel/CollegeRegistration/Graduation");
