jQuery(function ($) {
    ...
    $(document).on('click', '.JSDownloadBtn', function (e) {
        ...
        var isLateralEntry = $("#IsLateralEntry").val();
        var RegnNo = $("#cno").val();
        if ($.trim(RegnNo) !== "") {
            RegnNo = "&cno=" + RegnNo
        }
        ...
        if (isValidated && yearis && semis) {
            ...
            url += "&sem=" + Sem + "&ExamRollNo=" + ExamRollNo + "&IsLateralEntry=" + isLateralEntry + RegnNo;
    ...
    $(document).on('click', '.JSDownloadInExcel', function (e) {
        ...
        if (isValidated && yearis && semis) {
            var url = "/CUCollegeAdminPanel/RR/DownloadInExcel" + "/" + Year;
            url += "/" + Course_ID;
            if (Programme && Programme != "") {
                url += "?Programme=" + Programme;
            }
            url += "&sem=" + Sem + "&ExamRollNo=" + ExamRollNo + "&IsLateralEntry=" + isLateralEntry;
            window.open(url, '_blank');
        }
