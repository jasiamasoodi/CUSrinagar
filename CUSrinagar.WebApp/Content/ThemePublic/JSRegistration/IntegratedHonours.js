...
$(document).ready(function ($) {
    ...
    $(document).on('submit', '#StdRegistration', function (e) {
        ...
        if ($("#prevf").attr("value") !== "#jspreview") {
            if ($(this).valid()) {
                ...
                else if ($("#showorhideigsection").is(":Checked")) {
                    var IGChkCount = $("#StdRegistration").find('#CourseSection [id$="__IsClicked"]:checked').length;
                    if (Number(IGChkCount) <= 0) {
                        alert("Please select Integrated / Honor's / Professional Course(s)");
                        $("#Jspleasewait").hide();
                        return false;
                    }
                }
            ...
            if ($(this).valid()) {
                ...
                if (Number(ChkCountp) <= 0) {
                    ...
                    var IGChkCountp = $("#StdRegistration").find('#CourseSection [id$="__IsClicked"]:checked').length;
                    if (Number(IGChkCountp) <= 0) {
                        alert("Please select Integrated / Honor's / Professional Course(s)");
                        $("#Jspleasewait").hide();
                        return false;
                    }
    ...
    //    var IsNotJKResident = $("#StudentAddress_District option:selected").val() === "OTHER|OTHER";
    //    var allChecked = $('[id$="__IsClicked"]:checked');
    //    var count = allChecked.length;
    //    var jsFee = $("#Jsfee").text();

    //    var basicFee = $.trim(jsFee.substring(jsFee.lastIndexOf(":") + 1));
    ...
    //    onGenderChange($(this).val());
    //});
    //function onGenderChange(currentText) {
    //    if (String(currentText).toLocaleLowerCase() == "male") {
    //        $("#32996ce4-5613-4a2d-a565-030390d7f496").hide();
    //        $("#a7cb49e3-6e17-41d5-a696-62d8c5a8af1b").hide();
    //        $("#92aecc82-7eec-47e6-8696-b879c2c4f9d6").hide();
    //    } else {
    //        $("#32996ce4-5613-4a2d-a565-030390d7f496").show();
    //        $("#a7cb49e3-6e17-41d5-a696-62d8c5a8af1b").show();
    //        $("#92aecc82-7eec-47e6-8696-b879c2c4f9d6").show();
    //    }
    //    $("input[name='CoursesApplied_IDs']").prop("checked", false);
    //    $("#Jsfee").removeClass("quadrat");
    //    $("#Jsfee").text("");
    //    $("#TotalFee").val(0);
    //}
