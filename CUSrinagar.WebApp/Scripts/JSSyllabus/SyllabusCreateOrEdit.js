...
function uploadFile() {
    $("#myframe").load(function () {
        ...
        if (frameData == successText) {
            $.ajax({
                url: '/CUSrinagarAdminPanel/Syllabus/List',
...
$(document).on('change', '.ParentDDL', function (e) {
    ...
    var path = "/CUSrinagarAdminPanel/Syllabus/_GetChildDDL"
    if (Type != "" && Type != undefined) {
        $.ajax({
            url: path,
            data: { id: id, Semester: Semester, Type: Type, childType: childType, childSubType: childSubType },
            datatype: "json",
